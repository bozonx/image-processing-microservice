...
После запуска сервиса, откройте браузер и перейдите по адресу: `http://localhost:3000/`
...
- Информацию об очереди задач
- Превью оригинального и обработанного изображения
- Детальную статистику обработки (размер файла, степень сжатия, размеры)
