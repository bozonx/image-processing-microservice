...
- `X-Image-Width`: Ширина результирующего изображения в пикселях.
- `X-Image-Height`: Высота результирующего изображения в пикселях.
- `X-Image-Size`: Размер результирующего файла в байтах.
---
