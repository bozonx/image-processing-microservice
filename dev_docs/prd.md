...
4. **Управление Метаданными**
   ...
   - Сохранение определенных полей метаданных
...
- **Уровни Приоритета**:
  - `0` (Наивысший): Извлечение EXIF
  - `1` (Средний): Обработка изображений без трансформаций
  - `2` (Низкий): Обработка с трансформациями
...
### 14.1 Фаза 1: Основная Реализация (Неделя 1-2)
- [ ] Настройка проекта и адаптация boilerplate
- [ ] Реализация endpoint /process
- [ ] Реализация endpoint /exif
- [ ] Реализация управления очередью
- [ ] Unit тесты для основных функций

### 14.2 Фаза 2: Продвинутые Функции (Неделя 3)
- [ ] Поддержка всех форматов изображений
- [ ] Продвинутая обработка ошибок
- [ ] E2E тесты
- [ ] Оптимизация производительности

### 14.3 Фаза 3: Интеграция и Развертывание (Неделя 4)
- [ ] Интеграция с Media Storage
- [ ] Настройка и оптимизация Docker
